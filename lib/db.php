...
function sv_tag_widget(array $allTags, array $selectedTags, string $fieldName = 'tags'): string {
  ...
  <fieldset class="genre-widget" id="<?=$uid?>" style="border:1px solid var(--border);border-radius:8px;padding:10px;margin:0">
    ...
    <div style="display:flex;gap:6px;align-items:center;margin-top:6px">
      <select class="genre-delete-dropdown" style="flex:1;padding:4px 8px;font-size:12px;border:1px solid var(--border);border-radius:6px;background:#fff;color:var(--red)">
        <option value="">🗑 Genre global löschen…</option>
        <?php foreach ($allTags as $tag): ?>
