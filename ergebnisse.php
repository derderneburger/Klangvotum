...
<div class="page-header">
  ...
  <div class="row">
    ...
    <?php if(sv_is_admin($admin)): ?><a class="btn" id="csvExportBtn" href="<?=h($base)?>/ergebnisse.php?export=csv">CSV Export</a><?php endif; ?>
...
<?php if($canSeeNotes): ?><div id="dur-bar" style="display:none;position:sticky;top:0;z-index:100;background:#fff;border:1.5px solid var(--green-mid);border-radius:12px;padding:12px 16px;margin-top:12px;margin-bottom:10px;align-items:center;gap:16px;box-shadow:0 2px 12px rgba(0,0,0,.08)">
