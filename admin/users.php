...
<div class="card" style="margin-top:12px">
  <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:2px">
    <h3 style="margin-bottom:0">Neuen Benutzer anlegen</h3>
    <button type="button" class="btn" style="padding:4px 12px;font-size:12px" data-open-dialog="dlg-rollen-info">ℹ️ Wer kann was?</button>
  </div>
  <form method="post" class="grid form-grid-2" style="grid-template-columns:repeat(2,1fr);gap:10px;margin-top:10px">
...
<dialog id="dlg-rollen-info" class="sv-dialog" style="width:min(760px,calc(100vw - 24px))">
  <div class="sv-dialog__panel" tabindex="-1">
    <div class="sv-dialog__head">
      <div class="sv-dialog__title">Wer kann was?</div>
